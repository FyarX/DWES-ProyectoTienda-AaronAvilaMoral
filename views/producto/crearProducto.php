      ...
      <form action="<?= URL_BASE ?>producto/guardarProducto" method="POST" enctype="multipart/form-data">
          <div class="grid gap-6 sm:grid-cols-2">
              ...
              <div class="w-full">
                  ...
                  <input type="number" name="precio" id="precio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-1.5" required="">
              </div>
              <div class="w-full">
                    <label for="category" class="block mb-2 text-sm font-medium text-gray-900">Categoría</label>
                    <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-1.5">
                        <?php
                        use Helpers\Utils;
              ...
              <div class="sm:col-span-2">
                  ...
                  <input type="text" id="descripcion" rows="2" class="block p-1.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" ></input>
              </div>
          </div>
          <!-- Carga de archivos -->
            <div class="mt-6">
                <label for="imagen" class="block mb-2 text-sm font-medium text-gray-900">Imagen del Producto</label>
                <input type="file" name="imagen" id="imagen" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-1.5" required="">
            </div>
