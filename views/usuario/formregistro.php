...
<form class="max-w-md mx-auto" action="<?=URL_BASE?>usuario/registrarUsuario" method="POST">
    ...
    <button type="submit" name="botonRegistro" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mt-6">Registrar</button>
